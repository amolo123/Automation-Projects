...
public class AddOpportunityQuickTurn {
...
//		System.setOut(out);
	...
	@Test(priority = 1)
    public void addOpportunityQuickTurn() throws InterruptedException{
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='slds-page-header__title slds-m-right--small slds-truncate slds-align-middle']/span")));		
	    WebElement nameopp= driver.findElement(By.xpath("//div[@class='slds-page-header__title slds-m-right--small slds-truncate slds-align-middle']/span"));
		String actual= nameopp.getText(); 
	    String expected="Damien Pipes 2";
