...
public class EditSecurityAgencyPage {
...
WebDriver driver;
	...
	By chk7 = By.xpath("//div[@aria-label='Security agency  updated successfully']");
	
	//By agencyName = By.xpath("");
	
	
	public EditSecurityAgencyPage(WebDriver driver) {
	...
	public void agencyNameInp(String agenNam) {
		...
		driver.findElement(agencyName).clear();
	...
	public void editSubmit() {
		...
		WebDriverWait wait = new WebDriverWait(driver, 5);
 		...
 		String message = "Security agency updated successfully";
 		Assert.assertEquals(actual3, message);
 		System.out.println("Assert success submit success");
