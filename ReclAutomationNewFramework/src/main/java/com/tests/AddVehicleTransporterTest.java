...
public class AddVehicleTransporterTest extends StartTest{
	...
	public void addVehicle() throws InterruptedException {
		...
		addVehiclePage.vehicleOwnerSelect("Transporter");  //0-company   1- transporter  2-Ex-factory
		try {Thread.sleep(2000);} catch (InterruptedException e) {e.printStackTrace();}
		
		addVehiclePage.transporterSelect("Nilanjana Transport");
		
		addVehiclePage.vehicleNoInput("MH34 BT234");
		try {Thread.sleep(2000);} catch (InterruptedException e) {e.printStackTrace();}
