...
public class StartTest extends ExtentReportsClass {
	...
	public void openBrowser() throws IOException {
		...
		FileInputStream file = new FileInputStream("/home/ankita/git/Automation-Projects/ReclAutomationNewFramework/src/main/java/config.properties");
		prop.load(file);
...
//		}
		...
		Driver.driver.navigate().to(baseurl);
